...
export default function HeroSection() {
    return (
        ...
        >
            ...
            {/* Content Container */}
            <div className="relative z-10 mx-auto w-full max-w-7x px-4 sm:px-6 md:px-10 lg:px-15  xl:px-20 2xl:px-25">
            ...
            {/* Booking Form - Bottom */}
            <div className="absolute inset-x-0 bottom-0 z-20 mx-auto -mb-60 md:-mb-25 mt-10 w-full max-w-7xl px-4 sm:px-6 sm:mt-16 lg:mt-20 lg:px-8">
                <BookingForm />
            </div>
        </section>
    );
