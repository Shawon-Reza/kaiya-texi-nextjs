...
export default function ServicesPage2Card({ item }: ServicesPage2CardProps) {
    return (
        <article className="group relative h-72.5 overflow-hidden rounded-lg sm:h-80 lg:h-90">
            <img
                src={item.imageUrl}
                alt={item.title}
            ...
            <div className="absolute inset-x-0 bottom-0 translate-y-0 p-5 text-white opacity-100 transition-all duration-300 sm:translate-y-3 sm:opacity-0 sm:group-hover:translate-y-0 sm:group-hover:opacity-100 sm:group-focus-within:translate-y-0 sm:group-focus-within:opacity-100 sm:p-6">
