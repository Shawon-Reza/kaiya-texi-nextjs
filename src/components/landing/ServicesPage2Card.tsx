...
export default function ServicesPage2Card({ item }: ServicesPage2CardProps) {
  return (
    <article className="group relative h-[290px] overflow-hidden rounded-lg sm:h-[320px] lg:h-[360px]">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 p-5 text-white opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:translate-y-0 group-focus-within:opacity-100 translate-y-3 sm:p-6">
        ...
        <div className="mt-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-white text-zinc-900 sm:h-11 sm:w-11">
